...
import {Button, Checkbox, Col, Divider, Form, Input, InputNumber, Modal, Radio, Row, Select, Upload} from "antd";
                            ...
                            <Col span={8}>
                                <div className="mt-4">
                                    ...
                                    <div className="h-20 pb-1">
                                        <div>License</div>
                                        <div
                                            className="h-full bg-slate-100 rounded-md mt-2 flex items-center justify-center flex-col">
